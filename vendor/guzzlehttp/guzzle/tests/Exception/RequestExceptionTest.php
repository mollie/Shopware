...
/**
 * @covers GuzzleHttpV6\Exception\RequestException
 */
class RequestExceptionTest extends TestCase
{
    ...
    public function testCreatesGenerateException()
    {
        ...
        $this->assertInstanceOf('GuzzleHttpV6\Exception\RequestException', $e);
    }
    ...
    public function testCreatesClientErrorResponseException()
    {
        ...
        $this->assertInstanceOf('GuzzleHttpV6\Exception\ClientException', $e);
    }
    ...
    public function testCreatesServerErrorResponseException()
    {
        ...
        $this->assertInstanceOf('GuzzleHttpV6\Exception\ServerException', $e);
    }
    ...
    public function testWrapsRequestExceptions()
    {
        ...
        $this->assertInstanceOf('GuzzleHttpV6\Exception\RequestException', $ex);
