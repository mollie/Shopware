...
/**
 * @covers \GuzzleHttpV6\Handler\CurlFactory
 */
class CurlFactoryTest extends TestCase
{
    ...
    /**
     * @expectedException \GuzzleHttpV6\Exception\RequestException
    ...
    public function testRetriesWhenBodyCanBeRewound()
    {
        ...
        $fn = function ($r, $options) use (&$callHandler) {
            $callHandler = true;
            return \GuzzleHttpV6\Promise\promise_for(new Psr7\Response());
        };
    ...
    /**
     * @expectedException \GuzzleHttpV6\Exception\ConnectException
     */
