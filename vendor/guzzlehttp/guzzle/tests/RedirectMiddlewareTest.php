...
use GuzzleHttpV6\Middleware;
use GuzzleHttpV6\Psr7\Request;
use GuzzleHttpV6\Psr7\Response;
use GuzzleHttpV6\RedirectMiddleware;
use Psr\Http\Message\RequestInterface;
use PHPUnit\Framework\TestCase;

/**
 * @covers GuzzleHttpV6\RedirectMiddleware
 */
class RedirectMiddlewareTest extends TestCase
{
    ...
    /**
     * @expectedException \GuzzleHttpV6\Exception\TooManyRedirectsException
    ...
    /**
     * @expectedException \GuzzleHttpV6\Exception\BadResponseException
