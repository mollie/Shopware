...
use GuzzleHttpV6\Psr7\FnStream;
...
class FunctionsTest extends BaseTest
{
    ...
    {
        $s = $this->getMockBuilder('GuzzleHttpV6\Psr7\Stream')
            ->setMethods(['read', 'eof'])
    ...
    {
        $this->assertInstanceOf('GuzzleHttpV6\Psr7\Uri', Psr7\uri_for('/foo'));
        $this->assertInstanceOf(
            'GuzzleHttpV6\Psr7\Uri',
    ...
    public function testCreatesWithFactory()
    {
        ...
        $this->assertInstanceOf('GuzzleHttpV6\Psr7\Stream', $stream);
    ...
    {
        $s = Psr7\stream_for();
        $this->assertInstanceOf('GuzzleHttpV6\Psr7\Stream', $s);
    }
    ...
    public function testCanCreateIteratorBasedStream()
    {
        ...
        $p = Psr7\stream_for($a);
        $this->assertInstanceOf('GuzzleHttpV6\Psr7\PumpStream', $p);
    ...
    public function testReturnsAsIsWhenNoChanges()
    {
        $r1 = new Psr7\Request('GET', 'http://foo.com');
        $r2 = Psr7\modify_request($r1, []);
        $this->assertInstanceOf('GuzzleHttpV6\Psr7\Request', $r2);
