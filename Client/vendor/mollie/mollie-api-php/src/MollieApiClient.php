...
use _PhpScoperd1ad3ba9842f\GuzzleHttp\Client;
use _PhpScoperd1ad3ba9842f\GuzzleHttp\ClientInterface;
use _PhpScoperd1ad3ba9842f\GuzzleHttp\Exception\GuzzleException;
use _PhpScoperd1ad3ba9842f\GuzzleHttp\Psr7\Request;
...
class MollieApiClient
{
     ...
     */
    public function __construct(\_PhpScoperd1ad3ba9842f\GuzzleHttp\ClientInterface $httpClient = null)
    {
        $this->httpClient = $httpClient ? $httpClient : new \_PhpScoperd1ad3ba9842f\GuzzleHttp\Client([\_PhpScoperd1ad3ba9842f\GuzzleHttp\RequestOptions::VERIFY => \_PhpScoperd1ad3ba9842f\Composer\CaBundle\CaBundle::getBundledCaBundlePath(), \_PhpScoperd1ad3ba9842f\GuzzleHttp\RequestOptions::TIMEOUT => self::TIMEOUT]);
        $compatibilityChecker = new \Mollie\Api\CompatibilityChecker();
        $compatibilityChecker->checkCompatibility();
        $this->initializeEndpoints();
        $this->addVersionString("Mollie/" . self::CLIENT_VERSION);
        $this->addVersionString("PHP/" . \phpversion());
        $this->addVersionString("Guzzle/" . \_PhpScoperd1ad3ba9842f\GuzzleHttp\ClientInterface::VERSION);
    }
    ...
    public function performHttpCallToFullUrl($httpMethod, $url, $httpBody = null)
    {
        ...
        $request = new \_PhpScoperd1ad3ba9842f\GuzzleHttp\Psr7\Request($httpMethod, $url, $headers, $httpBody);
        try {
            $response = $this->httpClient->send($request, ['http_errors' => \false]);
        } catch (\_PhpScoperd1ad3ba9842f\GuzzleHttp\Exception\GuzzleException $e) {
     ...
     * @throws ApiException
     */
    private function parseResponseBody(\_PhpScoperd1ad3ba9842f\Psr\Http\Message\ResponseInterface $response)
    {
