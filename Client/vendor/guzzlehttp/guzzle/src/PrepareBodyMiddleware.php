    ...
    public function __invoke(\_PhpScoperd1ad3ba9842f\Psr\Http\Message\RequestInterface $request, array $options)
    {
        ...
        if (!$request->hasHeader('Content-Type')) {
            if ($uri = $request->getBody()->getMetadata('uri')) {
                if ($type = \_PhpScoperd1ad3ba9842f\GuzzleHttp\Psr7\mimetype_from_filename($uri)) {
        ...
        return $fn(\_PhpScoperd1ad3ba9842f\GuzzleHttp\Psr7\modify_request($request, $modify), $options);
    }
    private function addExpectHeader(\_PhpScoperd1ad3ba9842f\Psr\Http\Message\RequestInterface $request, array $options, array &$modify)
    {
