...
class RetryMiddleware
{
    ...
    private function onFulfilled(\_PhpScoper5c52a41b78b7a\Psr\Http\Message\RequestInterface $req, array $options)
    {
    ...
    private function onRejected(\_PhpScoper5c52a41b78b7a\Psr\Http\Message\RequestInterface $req, array $options)
    {
    ...
    private function doRetry(\_PhpScoper5c52a41b78b7a\Psr\Http\Message\RequestInterface $request, array $options, \_PhpScoper5c52a41b78b7a\Psr\Http\Message\ResponseInterface $response = null)
    {
