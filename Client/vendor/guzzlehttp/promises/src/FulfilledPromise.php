 ...
 */
class FulfilledPromise implements \_PhpScoperd1ad3ba9842f\GuzzleHttp\Promise\PromiseInterface
{
    private $value;
    ...
    public function then(callable $onFulfilled = null, callable $onRejected = null)
    {
        ...
        $queue = queue();
        $p = new \_PhpScoperd1ad3ba9842f\GuzzleHttp\Promise\Promise([$queue, 'run']);
        $value = $this->value;
