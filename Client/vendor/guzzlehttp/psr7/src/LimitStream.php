 ...
 */
class LimitStream implements \_PhpScoperd1ad3ba9842f\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\_PhpScoperd1ad3ba9842f\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
