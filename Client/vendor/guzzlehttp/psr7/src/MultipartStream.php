 ...
 */
class MultipartStream implements \_PhpScoperd1ad3ba9842f\Psr\Http\Message\StreamInterface
{
    ...
    {
        $stream = new \_PhpScoperd1ad3ba9842f\GuzzleHttp\Psr7\AppendStream();
    ...
    private function addElement(\_PhpScoperd1ad3ba9842f\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \_PhpScoperd1ad3ba9842f\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
