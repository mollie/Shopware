 ...
 */
class MultipartStream implements \_PhpScoper5cd2cac49fa56\Psr\Http\Message\StreamInterface
{
    ...
    {
        $stream = new \_PhpScoper5cd2cac49fa56\GuzzleHttp\Psr7\AppendStream();
    ...
    private function addElement(\_PhpScoper5cd2cac49fa56\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \_PhpScoper5cd2cac49fa56\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
