 ...
 */
class AppendStream implements \_PhpScoper5cd2cac49fa56\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\_PhpScoper5cd2cac49fa56\Psr\Http\Message\StreamInterface $stream)
    {
