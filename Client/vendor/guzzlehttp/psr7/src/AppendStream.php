 ...
 */
class AppendStream implements \_PhpScoperd1ad3ba9842f\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\_PhpScoperd1ad3ba9842f\Psr\Http\Message\StreamInterface $stream)
    {
