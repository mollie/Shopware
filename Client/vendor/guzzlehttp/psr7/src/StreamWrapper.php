...
class StreamWrapper
{
     ...
     */
    public static function getResource(\_PhpScoper5c52a41b78b7a\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\_PhpScoper5c52a41b78b7a\Psr\Http\Message\StreamInterface $stream)
    {
