...
class StreamWrapper
{
     ...
     */
    public static function getResource(\_PhpScoper5cd2cac49fa56\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\_PhpScoper5cd2cac49fa56\Psr\Http\Message\StreamInterface $stream)
    {
