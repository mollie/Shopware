 ...
 */
class FnStream implements \_PhpScoperd1ad3ba9842f\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\_PhpScoperd1ad3ba9842f\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
