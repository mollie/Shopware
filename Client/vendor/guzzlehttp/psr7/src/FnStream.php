 ...
 */
class FnStream implements \_PhpScoper5cd2cac49fa56\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\_PhpScoper5cd2cac49fa56\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
