...
<div class="mollie-components-credit-card" id="mollie_components_credit_card">
    ...
    <div class="block-group">
        <div class="block">
            <label for="cardHolder">{s namespace="frontend/mollie/plugins" name="CardHolderLabel"}Card holder name{/s}</label>
    ...
    <div class="block-group">
        <div class="block">
            <label for="cardNumber">{s namespace="frontend/mollie/plugins" name="CardNumberLabel"}Credit card number{/s}</label>
    ...
    <div class="block-group">
        <div class="b1 block">
            <label for="expiryDate">{s namespace="frontend/mollie/plugins" name="CardExpiryDateLabel"}Expiration date{/s}</label>
        ...
        <div class="b2 block">
            <label for="verificationCode">{s namespace="frontend/mollie/plugins" name="CardVerificationCodeLabel"}CVC{/s}</label>
    ...
    <div class="block-group">
        <div class="tag-line">
            <i class="icon--lock"></i>&nbsp;<span>{s namespace="frontend/mollie/plugins" name="CreditCardTagLine"}Payment secured and powered by{/s}</span>
